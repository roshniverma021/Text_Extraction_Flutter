...
class aadhaar_card_extraction extends StatelessWidget {
  const aadhaar_card_extraction({Key? key}) : super(key: key);
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: const SizedBox(
          width: 300,
          height: 100,
          child: Center(child: Text('Scan aadhaar card number')),
        ),
      ),
    );
  }
